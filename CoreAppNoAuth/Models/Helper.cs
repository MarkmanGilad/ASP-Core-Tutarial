...
namespace CoreAppNoAuth.Models
{
    public class Helper
    {
        ...
        public const string conString = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=MVCDB;Integrated Security=True;Connect Timeout=30;Encrypt=False";
        ...
        // The Method does't check if the user is already taken.
        {
            ...
            // עדכון הדאטה סט בבסיס הנתונים
            SqlCommandBuilder builder = new SqlCommandBuilder(adapter);
            int n = n = adapter.Update(ds, tblName);
            return n;
        }
